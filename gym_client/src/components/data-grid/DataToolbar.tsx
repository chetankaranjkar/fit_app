...
const selectClass =
  'rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-200 transition-colors focus:border-blue-400/50 focus:bg-white/[0.07] focus:outline-none sm:min-w-[8.5rem]'
