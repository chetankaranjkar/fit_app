/**
 * Tiny consistent icon set scoped to this module. Uses Heroicons-style outline
 * paths so nothing else in the app needs to change.
 */

type Props = { className?: string }
const base = (cls?: string) =>
  ['shrink-0', cls ?? 'size-4'].filter(Boolean).join(' ')

export const IconLocker = ({ className }: Props) => (
  <svg className={base(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z M12 4v16 M14.5 10h1.5 M14.5 12h1.5"
    />
  </svg>
)
...
export const IconX = ({ className }: Props) => (
  <svg className={base(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const IconWrench = ({ className }: Props) => (
  <svg className={base(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const IconAlert = ({ className }: Props) => (
  <svg className={base(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 9v2m0 4h.01M5.07 18h13.86A2 2 0 0020.76 15.82l-6.93-11.64a2 2 0 00-3.46 0L3.24 15.82A2 2 0 005.07 18z"
    />
  </svg>
)

export const IconUnlock = ({ className }: Props) => (
  <svg className={base(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M13 11V7a3 3 0 10-6 0v4m-1 0h12a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6a2 2 0 012-2z"
    />
  </svg>
)
