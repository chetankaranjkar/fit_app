...
{
    /// <summary>
    /// Creates Invoices / InvoiceItems — entities existed in the model snapshot but no prior migration added these tables.
    /// </summary>
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20260420120000_AddInvoicesTables")]
    public partial class AddInvoicesTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Invoices_user_memberships_UserMembershipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_UserMembershipId",
                table: "Invoices",
