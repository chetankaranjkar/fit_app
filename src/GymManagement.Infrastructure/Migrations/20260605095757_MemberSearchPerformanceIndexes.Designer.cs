...
namespace GymManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260605095757_MemberSearchPerformanceIndexes")]
    partial class MemberSearchPerformanceIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MinimumInvoiceAmount")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.CouponUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.FinancialAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("financial_audit_logs", (string)null);
                });

            modelBuilder.Entity("GymManagement.Domain.Entities.GymLead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomLeadSource")
                        .HasMaxLength(150)
                    ...
                    b.ToTable("gym_leads", (string)null);
                });
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.GymQrWorkoutSession", b =>
                {
                    ...
                    b.Property<DateTime>("LastActivityAtUtc")
                        .HasColumnType("datetime2")
                        .HasColumnName("LastActivityAtUtc");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.LeadFollowup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GymLeadId");

                    b.HasIndex("NextFollowUpAt");

                    b.ToTable("lead_followups", (string)null);
                });

            modelBuilder.Entity("GymManagement.Domain.Entities.LeadTrial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TrialDate");

                    b.ToTable("lead_trials", (string)null);
                });
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.LoginHistoryEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipApprovalRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PreviousMembershipStatus")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("membership_approval_requests", (string)null);
                });

            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipPaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("membership_payment_transactions", (string)null);
                });
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "RegistrationDate", "Id")
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "DeviceUniqueId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.WaiveOffRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("waive_off_requests", (string)null);
                });
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.WorkoutPlanDay", b =>
                {
                    ...
                    b.Property<int?>("WorkoutPlanWeekId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.WorkoutPlanWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.Coupon", b =>
                {
                    b.HasOne("GymManagement.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.GymLead", b =>
                {
                    b.HasOne("GymManagement.Domain.Entities.User", "ConvertedMember")
                        .WithMany()
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.LeadFollowup", b =>
                {
                    ...
                    b.HasOne("GymManagement.Domain.Entities.GymLead", "GymLead")
                        .WithMany("Followups")
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.LoginHistoryEntry", b =>
                {
                    b.HasOne("GymManagement.Domain.Entities.UserDevice", "Device")
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipApprovalRequest", b =>
                {
                    ...
                    b.HasOne("GymManagement.Domain.Entities.User", "RequestedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipAuditLog", b =>
                {
                    ...
                    b.HasOne("GymManagement.Domain.Entities.User", "PerformedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.MembershipPaymentTransaction", b =>
                {
                    b.HasOne("GymManagement.Domain.Entities.MembershipPayment", "Payment")
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.WorkoutPlanDay", b =>
                {
                    ...
                    b.HasOne("GymManagement.Domain.Entities.WorkoutPlanWeek", "Week")
                        .WithMany("Days")
