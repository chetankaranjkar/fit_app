...
namespace GymManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260610120000_AddWarmupsAndStretches")]
    public partial class AddWarmupsAndStretches : Migration
    {
        ...
        {
            migrationBuilder.Sql("IF OBJECT_ID(N'WorkoutPlanStretches', N'U') IS NOT NULL DROP TABLE [WorkoutPlanStretches];");
            migrationBuilder.Sql("IF OBJECT_ID(N'WorkoutPlanWarmups', N'U') IS NOT NULL DROP TABLE [WorkoutPlanWarmups];");
            migrationBuilder.Sql("IF OBJECT_ID(N'Stretches', N'U') IS NOT NULL DROP TABLE [Stretches];");
            migrationBuilder.Sql("IF OBJECT_ID(N'Warmups', N'U') IS NOT NULL DROP TABLE [Warmups];");
        }
    }
}
